#!/usr/bin/env python3
"""Build the COMPETITOR canonical News artifact from deterministic raw input."""
...
ARTIFACT_TYPE = "competitor_news"
READ_COMPETITOR_CATALOG = True
RAW_REQUIRED = {
...
def main() -> int:
    ...
    try:
        ...
        artifact, lineage = build_artifact(raw_payload, args.run_id, args.competitors)
